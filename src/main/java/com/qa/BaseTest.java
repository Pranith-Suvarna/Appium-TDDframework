...
//		server = getAppiumService(); // -> If using Mac, uncomment this statement and comment below statement
	...
	// for Mac. Update the paths as per your Mac setup and for Windows comment the environment lines
	public AppiumDriverLocalService getAppiumService() {
		HashMap<String, String> environment = new HashMap<String, String>();
		// if using this method for windows comment the below two environment lines
		...
		// for windows below two paths will change		
				.usingDriverExecutable(new File("/usr/local/bin/node"))
				.withAppiumJS(new File("/usr/local/lib/node_modules/appium/build/lib/main.js"))
				.usingPort(4723)
				.withArgument(GeneralServerFlag.SESSION_OVERRIDE)
//				.withArgument(() -> "--allow-insecure","chromedriver_autodownload")
				.withEnvironment(environment)    //for windows comment this environment line
  ...
  public MobileElement scrollToElement() {	
	/*	
	 * In case multiple scrollable elements present on the page add the parent element attribute in the command
	...
	*/
	  ...
	  // In case only single scrollable element is present on the page use  scrollable(true)
		return (MobileElement) ((FindsByAndroidUIAutomator) getDriver()).findElementByAndroidUIAutomator(
...
//	  RemoteWebElement parent = (RemoteWebElement)getDriver().findElement(By.className("XCUIElementTypeScrollView"));  //parent element
...
//	  scrollObject.put("predicateString", "label == 'ADD TO CART'");  //child element
